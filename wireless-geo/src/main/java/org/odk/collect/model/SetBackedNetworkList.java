...
public class SetBackedNetworkList extends AbstractList<Network> implements List<Network> {
        ...
        for (Network net: collection) {
            switch (net.getType()) {
                ...
                case NR:
                    ...
                    break;
                default:
                    Timber.e("unhandled addAll case: "+net.getType());
                    break;
            }
        }
        return added;
    ...
    public Network get(int i) {
        try {
            ...
            Timber.e("failed SBNL.get - index out of bound (likely structure changed) index: "+i);
            return null;
        }
    }
    ...
    public void sort(Comparator comparator) {
        try {
            ...
            Timber.w(iaex,"SBNL.sort: IllegalArgumentException");
