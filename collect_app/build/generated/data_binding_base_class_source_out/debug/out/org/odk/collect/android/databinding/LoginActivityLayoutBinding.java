...
public final class LoginActivityLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final Button biometricLogin;
  ...
  @NonNull
  public static LoginActivityLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LoginActivityLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.login_activity_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LoginActivityLayoutBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.biometric_login;
      Button biometricLogin = ViewBindings.findChildViewById(rootView, id);
